...
# ------------------------------------------------------------
Write-Host "[1/6] Setting up symlink: Applications -> User Start Menu..." -ForegroundColor Yellow
...
# ------------------------------------------------------------
Write-Host ""
Write-Host "[2/6] Moving shortcuts from All Users Start Menu to User Start Menu..." -ForegroundColor Yellow
...
# ------------------------------------------------------------
# STEP 3: Move Desktop shortcuts into User Start Menu root
# ------------------------------------------------------------
Write-Host ""
Write-Host "[3/6] Moving Desktop shortcuts into User Start Menu (Applications)..." -ForegroundColor Yellow
...
foreach ($file in $desktopShortcuts) {
    ...
    Move-Item -Path $file.FullName -Destination $destination -Force -ErrorAction SilentlyContinue
    if (-not (Test-Path $file.FullName)) { $desktopMoved++ }
}
Write-Host "   Moved $desktopMoved desktop shortcut(s)." -ForegroundColor Green

# ------------------------------------------------------------
# STEP 4: Flatten — pull all shortcuts from subfolders to root of User Start Menu
# ------------------------------------------------------------
Write-Host ""
Write-Host "[4/6] Flattening: moving all shortcuts to root..." -ForegroundColor Yellow
...
# ------------------------------------------------------------
Write-Host ""
Write-Host "[5/6] Filtering: removing uninstallers and junk from User Start Menu (Applications)..." -ForegroundColor Yellow
...
# ------------------------------------------------------------
Write-Host ""
Write-Host "[6/6] Cleaning All Users Start Menu..." -ForegroundColor Yellow
